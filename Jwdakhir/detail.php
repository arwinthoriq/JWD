	...
	<section class="arrival spad">
		<div class="container">
			...
			<div class="row product__filter">
				...
				?>
				<div class="card">
					<?php echo "<img src='img/".$result['gambar']."' alt='Avatar' style='width:100%'>";?>
					<div class="container">
						<br>
						<h4><b><?php  echo $result['nama']?></b></h4>
						<p><?php  echo $result['lokasi']?> | <b style="color:#47f07a;">Harga Tiket Rp <?php  echo $result['harga']?></b></p>
						<p><b><?php  echo $result['keterangan']?></b></p>
					</div>
				</div>
				<hr>
				<iframe allowfullscreen frameborder="0" height="315" src="https://www.youtube.com/embed/AKxGMae2OAU" title="YouTube video player" width="560"></iframe>
			</div>
		</div>
	</section>
	<footer class="footer">
